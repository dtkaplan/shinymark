...
ui <- fluidPage(
  ...
  sidebarLayout(
    ...
    sidebarPanel(
      themeSelector(),
      HTML("You could put in some instructions as simply as this!<br>And notice the ? after some of the  control names."),
      # Select variable for y-axis ----------------------------------
      selectInput(inputId = "y", 
                  label = HTML("Y-axis: <span title = 'Some help on what to use this control for.'>?</span>"),
      ...
      sliderInput(inputId = "alpha", 
                  label = HTML("Alpha:<span title='alpha is the word used for transparency'>?</span>"), 
                  min = 0, max = 1, 
                  value = 0.5),
