...
### Trying to put a plot inline

Here's the creation of a plot:
```{r carplot}
Plot1 <-
...
Let's put the plot inline^[Change `rbogus` to `r` to activate the inline code], right here: `rbogus Plot1`.

```{r another_error, error = TRUE}
sqrt(-5)
```
